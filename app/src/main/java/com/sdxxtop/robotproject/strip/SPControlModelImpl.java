 ...
 */
public class SPControlModelImpl {
    public static final String TAG = "SPControlModelImpl";

    private SPControlModelImpl() {
    }

    public static SPControlModelImpl getInstance() {
        return new SPControlModelImpl();
    }
    ...
    public void queryDevStatus(String did) {
        ...
        if (stdControlResult != null && stdControlResult.getStatus() == BLControllerErrCode.SUCCESS) {
            Log.e(TAG, "queryDevStatus: " +  (Integer) stdControlResult.getData().getVals().get(0).get(0).getVal());
...
//                    }
                    ...
                    Log.e(TAG, "stdControlResult: " + stdControlResult.getMsg());
//                    if (mSPControlListener != null) {
//                        mHandler.post(new Runnable() {
//                            @Override
//                            public void run() {
